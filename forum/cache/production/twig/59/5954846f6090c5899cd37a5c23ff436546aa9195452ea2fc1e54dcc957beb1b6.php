...
class __TwigTemplate_e58277023a398676bdcec7960bf286680361aa73a01d895b216c8b312d7b97b9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
            ...
            if ( !twig_get_attribute($this->env, $this->source, ($context["definition"] ?? null), "INCLUDED_COLPICKJS", [], "any", false, false, false, 3)) {
                // line 4
                echo "\t\t";
                $asset_file = "@phpbb_boardannouncements/colpick/colpick.js";
                ...
                echo "\t\t";
                $asset_file = "@phpbb_boardannouncements/colpick/colpick.css";
                $asset = new \phpbb\template\asset($asset_file, $this->env->get_path_helper(), $this->env->get_filesystem());
                if (substr($asset_file, 0, 2) !== './' && $asset->is_relative()) {
                    $asset_path = $asset->get_path();                    $local_file = $this->env->get_phpbb_root_path() . $asset_path;
                    if (!file_exists($local_file)) {
