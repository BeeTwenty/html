...
/* overall_header.html */
class __TwigTemplate_e3e98a2c0e1ca0fa9a0427adb29dd66991add2e69a45ce8b216355c9dabb3527 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $this->env->setNamespaceLookUpOrder(array('alex75_welcomeback', '__main__'));
        $this->env->loadTemplate('@alex75_welcomeback/event/overall_header_head_append.html')->display($context);
...
\t\t";
        ...
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('alex75_welcomeback', '__main__'));
        $this->env->loadTemplate('@alex75_welcomeback/event/overall_header_content_before.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
