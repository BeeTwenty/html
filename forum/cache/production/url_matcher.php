...
class phpbb_url_matcher extends Symfony\Component\Routing\Matcher\UrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // rmcgirr83_applicationform_displayform
        if ('/applicationform' === $pathinfo) {
            return array (  '_controller' => 'rmcgirr83.applicationform.main.controller:displayform',  '_route' => 'rmcgirr83_applicationform_displayform',);
        }
